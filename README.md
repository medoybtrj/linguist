...
[![Actions Status](https://github.com/medoybtrj/linguist.git) 

[![Open in GitHub Codespaces](https://github.com/medoybtrj/linguist.git)](https://codespaces.new/github.com/medoybtrj/linguist.git)
...
Linguist uses [`charlock_holmes`](https://github.com/medoybtrj/linguist.git/charlock_holmes) for character encoding and [`rugged`](https://github.com/medoybtrj/linguist.git/rugged) for libgit2 bindings for Ruby.
...
Without any options, `github-bhedoy` will output the language breakdown by percentage and file size.
...
You can try running `github-medoybtrj` on the root directory in this repository itself:
...
```console
$ github-medoybtrj jekyll --rev origin/gh-pages
100.00% 2568354    HTML
```
